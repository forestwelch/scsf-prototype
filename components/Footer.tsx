    ...
    <footer className="bg-brand-royal-blue text-white">
      <Container>
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <address className="not-italic text-sm space-y-2">
              <p>The Skating Club of San Francisco, Inc.</p>
              <p>P.O. BOX 320457</p>
              <p>San Francisco, CA 94132</p>
            </address>
            <div className="mt-4">
              <h4 className="font-semibold mb-2">Yerba Buena Ice Skating & Bowling Center</h4>
              <p className="text-sm">750 Folsom St., San Francisco, CA 94107</p>
              <p className="text-sm">Phone: (415) 820-3521</p>
            </div>
          </div>
          ...
          {/* Column 3: Social Media & External Links */}
          <div>
        ...
        <div className="border-t border-brand-sky-blue pt-6 pb-4 text-center text-sm text-gray-300">
          <p>&copy; {currentYear} The Skating Club of San Francisco, Inc. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
